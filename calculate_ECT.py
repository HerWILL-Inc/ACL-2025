...
def calculate_ECT_score(model,modelname,tokenizer,X,Y,A,metric):
    ...
    print(f"ECT score for model {modelname}: {score}")
...
def main():
    ...
    workbook = xlsxwriter.Workbook('ECT_socres.xlsx')
    worksheet = workbook.add_worksheet()

    # Define column names
    column_names = ['Model', 'STEM ECT Score', 'SHAPE ECT Score']
    ...
    for row_num,modelname in enumerate(modelnames,start=1):
        ...
        stem_score = calculate_ECT_score(model,
                                     modelname,
                                     tokenizer,
                                     male_words,
                                     female_words,
        ...
        shape_score = calculate_ECT_score(model,
                                     modelname,
                                     tokenizer,
                                     male_words,
                                     female_words,
